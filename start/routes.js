...
Route.post('/archive/update/:id', 'ArchiveController.updateQuote').validator('Archive')
...
Route.post('/profile_settings', 'ProfileSettingController.saveUsername').validator('ProfileSettings')
